...
const errorEnumValues = Object.values<StreamingError | string>(StreamingError).filter(
	(e) => typeof e === 'number'
) as unknown as number[]
const statusEnumValues = Object.values<StreamingStatus | string>(StreamingStatus).filter(
	(e) => typeof e === 'number'
) as unknown as number[]
