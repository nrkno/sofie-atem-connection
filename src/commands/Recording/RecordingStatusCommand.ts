...
const errorEnumValues = Object.values<RecordingError | string>(RecordingError).filter(
	(e) => typeof e === 'number'
) as unknown as number[]
const statusEnumValues = Object.values<RecordingStatus | string>(RecordingStatus).filter(
	(e) => typeof e === 'number'
) as unknown as number[]
